        ...
        char   *progname)   /* program name. */
{
    printf(
        ...
        "\n"
        "OPTIONS\n"
        "     -A      This option toggles the switch between using utf-8 box drawing\n"
        "             characters and ASCII characters.  Default is utf-8.\n"
        "\n"
        "     -a      This option toggles the inclusion of the last access time of the\n"
        "             file in the listing.\n"
        "\n"
        "     -c      This option toggles the inclusion of the last inode modification\n"
        "             to the file in the listing.\n"
        "\n"
        "     -g      This option toggles the inclusion of the group name of the file\n"
        "             to the file in the listing.\n"
        "\n"
        "     -H      This option toggles the show of hidden files and directories.\n"
        "\n"
        "     -h      This option toggles the display of the help screen.\n"
        "\n"
        "     -i      This option toggles the inclusion of the i-node number of the\n"
        "             file in the listing.\n"
        "\n"
        "     -l      This option toggles the inclusion of the number of links pointing\n"
        "             to this inode in the listing.\n"
        "\n"
        "     -m      This option toggles the inclusion of the last modification time\n"
        "             of the file in the listing.\n"
        "\n"
        "     -n      This option toggles numerical output (for user id and group id)\n"
        "             of the file in the listing.\n"
        "\n"
        "     -o      This option toggles the inclusion of the owner of the file in the\n"
        "             listing.\n"
        "\n"
        "     -p      This option toggles the inclusion of the permissions field in the\n"
        "             listing.\n"
        "\n"
        "     -r      This option toggles the sorting in reverse collation order of the\n"
        "             files in the listing.\n"
        "\n"
        "     -s      This option toggles the inclusion of the size field in the list-\n"
        "             ing.\n"
        "\n"
        "     -y      This option makes for symbolic links to print also the pointed\n"
        "             target.\n"
        "\n"
        "AUTHOR\n"
